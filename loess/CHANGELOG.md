...
- Added: [`quote_into_mixed_site!`](https://docs.rs/loess/latest/loess/macro.quote_into_mixed_site.html) (recommended), [`quote_into_same_site!`](https://docs.rs/loess/latest/loess/macro.quote_into_same_site.html) and [`quote_into_call_site!`](https://docs.rs/loess/latest/loess/macro.quote_into_call_site.html)
...
- Added: [`raw_quote_into_mixed_site!`](https://docs.rs/loess/latest/loess/macro.raw_quote_into_mixed_site.html) (recommended), [`raw_quote_into_same_site!`](https://docs.rs/loess/latest/loess/macro.raw_quote_into_same_site.html) and [`raw_quote_into_call_site!`](https://docs.rs/loess/latest/loess/macro.raw_quote_into_call_site.html)
